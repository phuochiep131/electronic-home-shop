...
const Banner = () => {
  ...
  if (loading) {
    return (
      <div className="h-[400px] bg-gray-200 animate-pulse rounded-2xl mx-4 mt-6"></div>
    );
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 h-auto md:h-[400px]">
              ...
              {(banner.title || banner.subtitle) && (
                <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex flex-col justify-center p-8 text-white">
                  ...
                  {banner.link_to && (
                    <a
                      href={banner.link_to}
                      className="bg-white text-blue-600 px-6 py-3 rounded-full font-bold hover:bg-blue-50 transition w-fit inline-block mt-4"
                    >
                      Mua ngay
                    </a>
                  )}
        ...
        <div className="md:col-span-4 flex flex-col gap-4 h-full hidden md:flex">
          <div className="flex-1 rounded-2xl overflow-hidden shadow-md relative cursor-pointer group">
            <img
              src="https://placehold.co/400x200/db2777/ffffff?text=Gia+Dụng+Bếp"
              alt="Sub 1"
          ...
          <div className="flex-1 rounded-2xl overflow-hidden shadow-md relative cursor-pointer group">
            <img
              src="https://placehold.co/400x200/16a34a/ffffff?text=Smart+Home"
              alt="Sub 2"
              className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
            />
          </div>
